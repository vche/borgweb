...
var i18n = require('./src/i18n'); //var log = require('./src/util').log
  ...
  $.getJSON("backups", function (data) {
    ...
    $.each(data, function (repo, repo_data) {
      ...
      $.each(repo_data.backups, function (p, backup) {
        ...
        jobsTemplate += "<div class=\"col-md-4\">\n              <div class=\"panel panel-primary\">\n              <div class=\"panel-heading\"> ".concat(backup.name, " </div>\n              <div class=\"panel-body\">\n              <table class=\"repo_info\"><thead><tr><th>Date</th><th>Size</th><th>Compr.</th><th>Dedup</th></tr></thead>\n              <tbody><tr><td>").concat(backup.date, "</td><td>").concat(backup.size, "</td><td>").concat(backup.csize, "</td><td>").concat(backup.dsize, "</td></tr></tbody></table>\n              </div></div></div>");
      }); // Build the repo global info

      var status = repo_data.last_result;
      var glyphicon = env.icon[status];
      repodivs += "<div class=\"panel-group\"><div class=\"panel panel-default\">\n            <div class=\"panel-heading\"> ".concat(repo, " </div>\n            <div class=\"panel-body\" id=\"repo-panel\">\n            <span class=\"glyphicon glyphicon-") + glyphicon[0] + " list-status-indicator\" aria-hidden=\"true\" style='color: " + glyphicon[1] + " '></span>"; // Optionally add the start button

      if ("script" in repo_data && repo_data.script != "") repodivs += "<button class='btn btn-primary pull-right'>Run</button>"; // Addd the status and the info table

      repodivs += "<a> Last backup: ".concat(repo_data.last_date, " ").concat(repo_data.last_time, " </a>\n            <table class=\"repo_info\"><thead><tr><th>Archives</th><th>Size</th><th>Compr.</th><th>Dedup</th></tr></thead>\n            <tbody><tr><td>").concat(repo_data.archives, "</td><td>").concat(repo_data.size, "</td><td>").concat(repo_data.csize, "</td><td>").concat(repo_data.dsize, "</td></tr></tbody></table>"); // Append the pannels for the backups

      repodivs += "".concat(jobsTemplate, "\n            </div></div></div>");
    });
